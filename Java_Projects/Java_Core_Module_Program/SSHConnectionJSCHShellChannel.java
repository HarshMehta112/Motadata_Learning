    ...
    public static void main(String[] args) throws IOException {
        ...
        try
        {
            ...
            if(jsch != null)
            {
                ...
                commander.println("vmstat -w | awk 'NR==3 {print $11}'");

                System.out.print("Total used memory in MB");

                commander.println("free -mt | awk 'NR==4 {print $3}'");
                ...
                commander.println("mpstat | awk 'NR==4 {print $5}'");

                System.out.print("Total no of transfers per sec");

                commander.println("iostat | awk 'NR==20 {print $2}'");
